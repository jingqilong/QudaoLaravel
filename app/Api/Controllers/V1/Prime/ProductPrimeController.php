...
class ProductPrimeController extends ApiController
{
    ...
    /**
     * @OA\Post(
     *     path="/api/v1/prime/admin/add_product",
     *     tags={"精选生活商户后台"},
     *     summary="添加产品",
     *     description="sang" ,
    ...
    public function addProduct()
    {
        ...
        $res = $this->productsService->addProduct($this->request,$merchant->id,$merchant->type);
        if ($res === false){
    ...
    /**
     * @OA\Delete(
     *     path="/api/v1/prime/admin/delete_product",
     *     tags={"精选生活商户后台"},
     *     summary="删除产品",
     *     description="sang" ,
    ...
    public function deleteProduct()
    {
        ...
        $merchant = Auth::guard('prime_api')->user();
        $res = $this->productsService->deleteProduct($this->request,$merchant->id);
        if ($res === false){
            return ['code' => 100, 'message' => $this->productsService->error];
        }
        return ['code' => 200, 'message' => $this->productsService->message];
    ...
    /**
     * @OA\Post(
     *     path="/api/v1/prime/admin/edit_product",
     *     tags={"精选生活商户后台"},
     *     summary="修改产品",
     *     description="sang" ,
    ...
    public function editProduct()
    {
        ...
        $merchant = Auth::guard('prime_api')->user();
        $res = $this->productsService->editProduct($this->request,$merchant->id);
        if (is_string($res)){
    ...
    /**
     * @OA\Get(
     *     path="/api/v1/prime/admin/product_list",
     *     tags={"精选生活商户后台"},
     *     summary="获取产品列表",
     *     description="sang" ,
    ...
    public function productList()
    {
        ...
        $merchant = Auth::guard('prime_api')->user();
        $res = $this->productsService->productList($this->request,$merchant->id);
        if ($res === false){
            return ['code' => 100, 'message' => $this->productsService->error];
        }
