...
class ControllerResolver implements ControllerResolverInterface
{
     ...
     *
     * @param string $controller A ApiController string
     *
    ...
    private function getControllerError($callable)
    {
        ...
        if (\is_object($callable)) {
            ...
            return sprintf('ApiController class "%s" cannot be called without a method name. You need to implement "__invoke"%s.', \get_class($callable), $alternativeMsg);
        }
