...
class ControllerResolverTest extends TestCase
{
    ...
    public function getUndefinedControllers()
    {
        ...
        return [
            ...
            ['Symfony\Component\HttpKernel\Tests\Controller\ControllerTest', \InvalidArgumentException::class, 'The controller for URI "/" is not callable. ApiController class "Symfony\Component\HttpKernel\Tests\ApiController\ControllerTest" cannot be called without a method name. You need to implement "__invoke" or use one of the available methods: "publicAction", "staticAction".'],
            ...
            [$controller, \InvalidArgumentException::class, 'The controller for URI "/" is not callable. ApiController class "Symfony\Component\HttpKernel\Tests\ApiController\ControllerTest" cannot be called without a method name. You need to implement "__invoke" or use one of the available methods: "publicAction", "staticAction".'],
