...
class AddAnnotatedClassesToCachePassTest extends TestCase
{
    public function testExpandClasses()
    {
        ...
        $this->assertSame(
            'Acme\\FooBundle\\ApiController\\DefaultController',
            $expand(['**Bundle\\ApiController\\'], ['\\Acme\\FooBundle\\ApiController\\DefaultController'])[0]
        );

        $this->assertSame(
            'FooBundle\\ApiController\\DefaultController',
            $expand(['**Bundle\\ApiController\\'], ['\\FooBundle\\ApiController\\DefaultController'])[0]
        );

        $this->assertSame(
            'Acme\\FooBundle\\ApiController\\Bar\\DefaultController',
            $expand(['**Bundle\\ApiController\\'], ['\\Acme\\FooBundle\\ApiController\\Bar\\DefaultController'])[0]
        );

        $this->assertSame(
            'Bundle\\ApiController\\Bar\\DefaultController',
            $expand(['**Bundle\\ApiController\\'], ['\\Bundle\\ApiController\\Bar\\DefaultController'])[0]
        );

        $this->assertSame(
            'Acme\\Bundle\\ApiController\\Bar\\DefaultController',
            $expand(['**Bundle\\ApiController\\'], ['\\Acme\\Bundle\\ApiController\\Bar\\DefaultController'])[0]
        );
