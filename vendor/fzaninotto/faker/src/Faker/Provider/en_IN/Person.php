...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $lastName = array(
        ...
        'Dad','Dada','Dalal','Dani','Dar','Dara','Das','Dasgupta','Dash','Dass','Date','Datta','Dave','Dayal','De','Deep','Deo','Deol','Desai','Deshmukh','Deshpande','Devan','Devi','Dewan','Dey','Dhaliwal','Dhar','Dhawan','Dhillon','Dhingra','Dial','Din','Divan','Dixit','Medical','Dodiya','Dora','Doshi','Dua','Dube','Dubey','Dugal','Dugar','Dutt','Dutta','D’Alia','Dyal',
        'Edwin',
